...
export type AccountsControllerMessenger = RestrictedMessenger<typeof controllerName, AccountsControllerActions | AllowedActions, AccountsControllerEvents | AllowedEvents, AllowedActions['type'], AllowedEvents['type']>;
...
export declare class AccountsController extends BaseController<typeof controllerName, AccountsControllerState, AccountsControllerMessenger> {
     ...
     */
    updateAccountMetadata(accountId: string, metadata: Partial<InternalAccount['metadata']>): void;
    /**
...
export {};
//# sourceMappingURL=AccountsController.d.mts.map